...
Obviously all of this could be btained from the website anyway, hence my putting it here in a public repository, if anyone does want (unlikely though that seems) they are free to branch it for themselves.
